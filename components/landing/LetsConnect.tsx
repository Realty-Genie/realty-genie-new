...
export const LetsConnect = () => {
    ...
    return (
        <section className="py-16 sm:py-24 md:py-32 px-4 md:px-8 max-w-7xl mx-auto relative z-10">
            <motion.div
            ...
            >
                <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] p-1">
                    ...
                    <div className="relative bg-[#0f172a] rounded-[1.85rem] p-5 sm:p-8 md:p-16">
                        ...
                        <div className="relative z-10 grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                            ...
                            <div className="text-center lg:text-left">
                                ...
                                <motion.h2
                                    ...
                                    className="text-2xl sm:text-3xl md:text-5xl font-bold tracking-tight text-white mb-4 sm:mb-6 leading-tight"
                                >
                                    Let's Connect & <br />
                                ...
                                <motion.p
                                    ...
                                    className="text-slate-400 text-base sm:text-lg leading-relaxed max-w-md mx-auto lg:mx-0 mb-4"
                                >
                                ...
                                <motion.p
                                    ...
                                    className="text-slate-500 text-sm sm:text-base leading-relaxed max-w-md mx-auto lg:mx-0"
                                >
                                    ...
                                    <div className="relative group">
                                        <div className="flex flex-col sm:flex-row gap-2">
                                            ...
                                            <select
                                                ...
                                                className="pl-3 pr-8 py-4 bg-white/5 border border-blue-500/30 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300 hover:border-blue-500/40 ring-1 ring-blue-500/20 appearance-none cursor-pointer w-full sm:w-auto sm:min-w-[110px]"
                                            ...
                                            <div className="relative flex-1 min-w-0">
                                                ...
                                                <input
                                                    ...
                                                    onChange={handleChange}
                                                    required
                                                    className="w-full pl-12 pr-4 py-4 bg-white/5 border border-blue-500/30 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300 hover:border-blue-500/40 ring-1 ring-blue-500/20"
                                                />
                                            </div>
                                        </div>
                                        <span className="block mt-1.5 text-xs text-blue-400/80 font-medium">Required</span>
                                    </div>
