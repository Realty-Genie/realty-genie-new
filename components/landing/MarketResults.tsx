            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-[#0F172A] mb-6">
                        Authority Built on <span className="text-blue-600 italic">Accuracy</span>.
                    </h2>
                    <p className="text-lg text-muted-foreground font-medium max-w-2xl mx-auto">
                        Stop guessing about the market. Start leading the conversation with data that builds elite-level trust.
                    </p>
                </div>

                <div className="grid grid-cols-1 gap-6 mb-20">
                    <ResultItem
                        title="Stronger trust and authority with clients"
                        delay={0.1}
                    />
                    <ResultItem
                        title="Handle uncertain markets with immediate, data-backed answers"
                        delay={0.2}
                    />
                    <ResultItem
                        title="Consistent, high-value nurture content delivered every month"
                        delay={0.3}
                    />
                    <ResultItem
                        title="Positioned as the go-to expert above local competition"
                        delay={0.4}
                    />
                </div>

                <div className="relative group">
                    <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-indigo-500 to-blue-400 rounded-[2.5rem] blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
                    <div className="relative bg-[#0F172A] rounded-[2rem] p-12 text-center text-white overflow-hidden shadow-2xl">
                        <div className="relative z-10 space-y-8 max-w-2xl mx-auto">
                            <h3 className="text-3xl md:text-4xl font-bold tracking-tight">
                                Ready to be the smartest person in the room?
                            </h3>
                            <p className="text-lg text-slate-300 font-medium">
                                Join our beta program for Market Intelligence and start dominating your local market chat today.
                            </p>
                            <div className="pt-4">
